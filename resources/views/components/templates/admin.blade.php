...
<body class="bg-gray-50">
    ...
    <header
        ...
        <nav class="flex items-center w-full px-4 mx-auto sm:px-6 basis-full">
            ...
            <div class="flex items-center justify-end w-full ms-auto gap-x-1 md:gap-x-3">
    ...
    <!-- ========== MAIN CONTENT ========== -->
    <!-- Breadcrumb -->
    <div class="sticky inset-x-0 top-0 z-20 px-4 bg-white border-y sm:px-6 lg:px-8 lg:hidden">
