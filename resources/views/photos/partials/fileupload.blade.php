<div class="space-y-2">
    <div id="img_path-container" class="relative w-full mb-4">
        <label for="album_thumb" class="inline-block text-md font-semibold text-neutral-800 mt-2.5 mb-2">
            Image
        </label>
        <input type="file" id="img_path" name="img_path" class="hidden" onchange="handleFileSelect(this)"
    ...
    <div class="flex items-center justify-center w-full">
        @if ($photo->img_path)
            <img class="w-64 rounded-xl" src="{{ asset($photo->path) }}" alt="{{ $photo->name }}">
        @endif
    </div>
